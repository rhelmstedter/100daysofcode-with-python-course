...
def main():
    ...
    for r in results:
        print(
            f"{r.title} with code {r.imdb_code} and director {r.director} has score {r.imdb_score}"
        )
...
def get_params():
    ...
    parser.add_argument(
        dest="mode", widget="Dropdown", choices=["Director", "IMDB Code", "Keyword"]
    )
